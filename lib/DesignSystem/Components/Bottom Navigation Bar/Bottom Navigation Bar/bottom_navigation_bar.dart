...
class CustomBottomNavigationBar extends StatefulWidget {
  ...
  const CustomBottomNavigationBar._({super.key, required this.viewModel});

  @override
  State<CustomBottomNavigationBar> createState() => _CustomBottomNavigationBarState();

  // Método para instanciar o widget com o ViewModel apropriado
  static Widget instantiate({Key? key, required ActionBottomBarViewModel viewModel}) {
    return CustomBottomNavigationBar._(key: key, viewModel: viewModel);
  }
}
